...
client.on("userUpdate", async function(oldUser, newUser) { // matthe qwe
    ...
    const embed = new Discord.MessageEmbed().setAuthor(member.displayName, member.user.avatarURL({ dynamic: true })).setColor('#e4b400').setTimestamp().setFooter('Matthe x Jahky');
